module.exports = (app,connection) => {
    app.post('/TransExternas', async (req,res) => {
        connection.query(`select Transferencia.Id_Trans,Sede.Nombre as 'NSede',Producto.Nombre as 'NProducto', Cantidad,Encargado.Nombre as 'Encargado'from Producto_Trans
        ...
        inner join Sede on (Sede.Id_Sede=Transferencia.Id_Sede) where  Tipo=0;
